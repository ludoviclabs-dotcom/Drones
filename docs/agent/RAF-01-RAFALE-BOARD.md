...
| `"C:/Program Files/Blender Foundation/Blender 5.1/blender.exe" --background --factory-startup --python tools/rafale-3d/generate-rafale.py -- --spec rafale-f4` | OK — `inverted_normals` vide, 32 418 triangles uniques, 66 nœuds, 34 matériaux ; GLB de 237 576 octets (~232 Ko) |
